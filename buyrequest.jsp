...
<form action="index.jsp">
   ...
   <label id="img_category_label"class="field"for="img_category">
	<span >Brand</span>
 ...
 <div class="col-md-4">
   ...
   <label id="img_category_label"class="field"for="img_category"data-value="">
	...
	<div id="img_category" class="psuedo_select" name="img_category">
		<span class="selected"></span>
		<ul id="img_category_options"class="options">
			<li class="option"data-value="1"> 200 - 350</li>
			<li class="option"data-value="2"> 350 -  500 </li>
			<li class="option"data-value="1"> 500 -  650</li>
			<li class="option"data-value="2"> 650 -  800 </li>
		</ul>
	</div>
</label>
 ...
 <div class="col-md-4">
   ...
   <label id="img_category_label"class="field"for="img_category"data-value="">
	...
	<div id="img_category"class="psuedo_select"name="img_category">
		<span class="selected"></span>
		<ul id="img_category_options"class="options">
			<li class="option"data-value="electric">electric</li>
			<li class="option"data-value="cng">cng</li>
			<li class="option"data-value="petrol">petrol</li>
			<li class="option"data-value="lpg">lpg</li>
			<li class="option"data-value="diesel">diesel</li>
			<li class="option"data-value="hybrid">hybrid</li>
			<li class="option"data-value="others">others</li>
		</ul>
	</div>
</label>
   ...
   <label id="img_category_label"class="field"for="img_category"data-value="" ">
	...
	<div id="img_category"class="psuedo_select"name="img_category">
		<span class="selected"></span>
		<ul id="img_category_options"class="options">
			<li class="option"data-value="1">less than 2000</li>
			<li class="option"data-value="2">> 2000 -  4000</li>
			<li class="option"data-value="3">> 4000 -  8000</li>
			<li class="option"data-value="4">> 8000 -  10000</li>
		</ul>
	</div>
   ...
   <label id="img_category_label"class="field"for="img_category"data-value="" ">
	...
	<div id="img_category" class="psuedo_select" name="img_category">
	<% zipcode =statement.executeQuery("SELECT distinct ZIP_CODE FROM LOCATION");%>
		<span class="selected"></span>
		<ul id="img_category_options"class="options">
			
			<%  while(zipcode.next()){ %>
            		<li class="option"><%=zipcode.getInt(1)%></li>
        			<% } %>
 ...
 function x(){
	 alert("Your ad has been posted succesfully!");
              ...
              <input type="submit" value ="Apply Filters" onclick = "x()" class="flex-c-m size2 m-text2 bg3 hov1 trans-0-4">
         </form>
  </section>
          <!-- block2 -->
